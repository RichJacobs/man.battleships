...
class Bot2(Bot):
    ...
    def __init__(self):
        super().__init__()
        self.my_shots = []
        self.recent_hits = []  # array of coordinates that were hits
    ...
    def get_shot(self) -> Point:
        ...
        if last_shot_status['is_hit'] and not last_shot_status['is_sunk']:
            if random.randrange(0, 1) == 1:
                x = last_shot_status['shot'].x
            else:
                y = last_shot_status['shot'].y
